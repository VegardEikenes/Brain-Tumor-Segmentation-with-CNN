...
def build_attention_unet(n_channels, ker_init, dropout, batchnorm=True):
    ...
    up_conv_5 = Conv2D(128, 3, padding='same', kernel_initializer=ker_init)(up_5)
    up_conv_5 = InstanceNormalization(axis=-1)(up_conv_5)
    up_conv_5 = Activation("relu")(up_conv_5)
    # up_conv_5 = Dropout(dropout)(up_conv_5)
    up_conv_5 = Conv2D(128, 3, padding='same', kernel_initializer=ker_init)(up_conv_5)
    up_conv_5 = InstanceNormalization(axis=-1)(up_conv_5)
    up_conv_5 = Activation("relu")(up_conv_5)
    ...
    up_conv_4 = Conv2D(64, 3, padding='same', kernel_initializer=ker_init)(up_4)
    up_conv_4 = InstanceNormalization(axis=-1)(up_conv_4)
    up_conv_4 = Activation("relu")(up_conv_4)
    # up_conv_4 = Dropout(dropout)(up_conv_4)
    up_conv_4 = Conv2D(64, 3, padding='same', kernel_initializer=ker_init)(up_conv_4)
    up_conv_4 = InstanceNormalization(axis=-1)(up_conv_4)
    up_conv_4 = Activation("relu")(up_conv_4)
    ...
    up_conv_3 = Conv2D(32, 3, padding='same', kernel_initializer=ker_init)(up_3)
    up_conv_3 = InstanceNormalization(axis=-1)(up_conv_3)
    up_conv_3 = Activation("relu")(up_conv_3)
    # up_conv_3 = Dropout(dropout)(up_conv_3)
    up_conv_3 = Conv2D(32, 3, padding='same', kernel_initializer=ker_init)(up_conv_3)
    up_conv_3 = InstanceNormalization(axis=-1)(up_conv_3)
    up_conv_3 = Activation("relu")(up_conv_3)
    ...
    up_conv_2 = Conv2D(16, 3, padding='same', kernel_initializer=ker_init)(up_2)
    up_conv_2 = InstanceNormalization(axis=-1)(up_conv_2)
    up_conv_2 = Activation("relu")(up_conv_2)
    # up_conv_2 = Dropout(dropout)(up_conv_2)
    up_conv_2 = Conv2D(16, 3, padding='same', kernel_initializer=ker_init)(up_conv_2)
    up_conv_2 = InstanceNormalization(axis=-1)(up_conv_2)
    up_conv_2 = Activation("relu")(up_conv_2)
